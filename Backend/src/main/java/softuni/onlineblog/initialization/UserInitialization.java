...
public class UserInitialization implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user = new User("ivan12", "ivan12345", "ivan@abv.bg", "https://static.toiimg.com/photo/72975551.cmsxqFwoTCOCsqumrpe0CFQAAAAAdAAAAABAD",
                LocalDateTime.now(), null, Set.of(roleUser), null, null, null);

        User admin = new User("valeri", "valeri12345", "valeri@abv.bg", "https://i.ytimg.com/vi/WhIrvsbEJ6Q/maxresdefault.jpg",
